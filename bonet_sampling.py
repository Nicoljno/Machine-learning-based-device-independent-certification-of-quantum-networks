...
#non-locality of experimental data for the instrumental scenario.
#To generate the input samples we use the bipartite Bell data and
#the lifting to retrieve the instrumental causal structure
...
for _ in range(200000):
    for a in vals:
        for b in vals:
            for y in vals:
                p_bon[a,b,2,y]=abs(a-1)*sum(p[_][y*4+a_*2+b] for a_ in vals)
