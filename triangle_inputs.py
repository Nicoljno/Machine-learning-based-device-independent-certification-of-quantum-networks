...
def custom_loss(train, y_pred):
    ...
    I=[]
    for _ in range(1):
        #I.append((y_pred[_][117]+train[_][53])+(y_pred[_][115]+train[_][51])+(y_pred[_][114]+train[_][50])-(y_pred[_][120]+train[_][56]))
        I.append((y_pred[_][113]+train[_][49])+(y_pred[_][114]+train[_][50])+(y_pred[_][115]+train[_][51])+(y_pred[_][117]+train[_][53])-(y_pred[_][116]+train[_][52])-(y_pred[_][118]+train[_][54])-(y_pred[_][119]+train[_][55])-(y_pred[_][120]+train[_][56]))
        #I.append((y_pred[_][113]+train[_][49])**2+(y_pred[_][116]+train[_][52])**2+(y_pred[_][118]+train[_][54])**2+(y_pred[_][119]+train[_][55])**2+
        #         3.*((y_pred[_][120]+train[_][56])**2+(y_pred[_][114]+train[_][50])**2+(y_pred[_][115]+train[_][51])**2+(y_pred[_][117]+train[_][53])**2)+
        #         2.*((y_pred[_][116]+train[_][52])*((y_pred[_][119]+train[_][55])-(y_pred[_][113]+train[_][49]))+ (y_pred[_][119]+train[_][55])*((y_pred[_][118]+train[_][54])-(y_pred[_][113]+train[_][49]))+(y_pred[_][118]+train[_][54])*((y_pred[_][116]+train[_][52])-(y_pred[_][113]+train[_][49])))+
        #         6.*((y_pred[_][115]+train[_][51])*((y_pred[_][117]+train[_][53])-(y_pred[_][120]+train[_][56]))+(y_pred[_][114]+train[_][50])*((y_pred[_][115]+train[_][51])-(y_pred[_][120]+train[_][56]))+(y_pred[_][117]+train[_][53])*((y_pred[_][114]+train[_][50])-(y_pred[_][120]+train[_][56]))))
        Gamma=(Id+A0A1*(y_pred[_][64]+train[_][0])+B0B1*(y_pred[_][65]+train[_][1])+C0C1*(y_pred[_][66]+train[_][2])+
               ...
               A0B0C0*(y_pred[_][113]+train[_][49])+
               A0B0C1*(y_pred[_][114]+train[_][50])+
               A0B1C0*(y_pred[_][115]+train[_][51])+
               A0B1C1*(y_pred[_][116]+train[_][52])+
               A1B0C0*(y_pred[_][117]+train[_][53])+
               A1B0C1*(y_pred[_][118]+train[_][54])+
               A1B1C0*(y_pred[_][119]+train[_][55])+
               A1B1C1*(y_pred[_][120]+train[_][56]))
...
output9 = Dense(57, activation = 'tanh', activity_regularizer=regularizers.l2(1e-6))(hidden7)
output=tf.concat([output1, output2,output3,output4,output5, output6,output7,output8,output9], axis=-1)
opt=keras.optimizers.SGD(learning_rate=0.00005, momentum=0.99)
model=Model(inputs = visible, outputs = output)
model.compile(optimizer=opt, loss=custom_loss)

#input_=pd.read_table('coeff_triangle.txt', delimiter=" ", header=None)
#input_=input_[0:10000]
#input_=input_.to_numpy()
#input_=input_.astype('float32')
#input_=np.concatenate((input_, np.zeros((1000,57))), axis=0)
input_=np.zeros((60000,57))
#input_=input_.astype('float32')
